...
:build
%_buildprefix% dotnet msbuild "%_buildproj%" /nologo /maxcpucount /verbosity:minimal /fileloggerparameters:Verbosity=detailed;LogFile="%_buildlog%";Append %* %_buildpostfix%
